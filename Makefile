...
PKG_SOURCES	=  tclarchive.c tclarchive_version.c tclarchive_extract.c tclarchive_create.c
PKG_OBJECTS	=  tclarchive.o tclarchive_version.o tclarchive_extract.o tclarchive_create.o
...
PKG_LIB_FILE	= libarchive0.6.so
PKG_LIB_FILE8	= libarchive0.6.so
PKG_LIB_FILE9	= libtcl9archive0.6.so
PKG_STUB_LIB_FILE = libarchivestub0.6.a
...
top_builddir	= /home/danilo/Public/tcl-archive
